...
function M._load(options)
  ...
  h('IncSearch', { fg = groups.background, bg = p.high1 })
  h('LineNr', { fg = p.low2 })
  h('MatchParen', { fg = p.text, bg = p.low3 })
  h('ModeMsg', { fg = p.low1 })
  ...
  h('NeogitDiffAdd', { link = 'DiffAdd' })
  h('NeogitDiffAddHighlight', { link = 'DiffAdd' })
  h('NeogitDiffContextHighlight', { bg = p.low4 })
  h('NeogitDiffDelete', { link = 'DiffRemoved' })
  h('NeogitDiffDeleteHighlight', { link = 'DiffRemoved' })
  ...
  h('@neorg.markup.verbatim', { fg = groups.comment })
  h('@neorg.markup.verbatim', { fg = groups.comment })
  h('@neorg.anchors.declaration.norg', { fg = p.blue })
